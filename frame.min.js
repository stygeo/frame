...
a,b)}}else a()}var f={},l,p=0;l=function(a,b){return f.hasOwnProperty.call(a,b)};var v=function(a){a instanceof Array||(a=[a]);return a},w=function(a){var b=(++p).toString();a&&(b=a+"-"+b);return b};g.history.originalPushState=g.history.pushState;g.history.pushState=function(a){var b=g.history.originalPushState.apply(g.history,arguments);$(g).trigger("pushstate",a);return b};String.prototype.pluralize=function(){return"s"===this[this.length-1]?this:this+"s"};String.prototype.singularize=function(){return"s"===
this[this.length-1]?this.substr(0,this.length-1):this};String.prototype.camelCase=function(){return this.toLowerCase().replace(/-(.)/g,function(a,b){return b.toUpperCase()})};var B=function(a,b){function h(){return a.apply(this,b)}h.prototype=a.prototype;return new h},q={getEvent:function(a){void 0===this._events&&(this._events={});return void 0!==a?(void 0===this._events[a]&&(this._events[a]=[]),this._events[a]):this._events},on:function(a,b,h){this.getEvent(a).push({callback:b,scope:h});return this},
off:function(a,b){if(void 0===b)this.getEvent(a).length=0;else if("function"===typeof b)for(var h=this.getEvent(a),c=0;c<h.length;c++){var d=h[c];if(d.callback===b){h.splice(c,1);break}}else if("object"===typeof b)if(h=this._events,"for"in b&&b.for)for(a in h)for(var e=h[a],c=0;c<e.length;c++)"object"===typeof e[c].scope&&(e.splice(c,1),c=0);else if("all"in b&&b.all)for(a in h){for(var f=[],e=h[a],c=0;c<e.length;c++)d=e[c],"object"===typeof d.scope&&f.push(d);for(c=0;c<f.length;c++)h[a].splice(h[a].indexOf(f[c]),
...
0;c<this.length;c++)a.call(b||this,this[c],c)}},n=function(a){var b;b=a instanceof Array?a:Array.prototype.slice.call(arguments,0);0<b.length&&t.push.apply(this,b)};n.prototype=[];_.extend(n.prototype,m);_.extend(n.prototype,k.prototype);_.extend(n.prototype,q);var u=k.extend({constructor:function(a,b){this.dirtyAttributes=[];k.call(this,a);this.isNew=!0;a&&this.setDirtyAttributes(_.keys(a))},setProperty:function(a,b,c){u.__super__.setProperty.call(this,a,b,c);this.setDirtyAttributes(a)},setDirtyAttributes:function(a){a instanceof
...
this.onchange,this);a.on("change",this.onchange,this);this._model=a;this.draw()},get:function(){return this._model}});var C=r.extend({tag:"button",constructor:function(a){a||(a={});r.call(this,a);"text"in a&&this.text(a.text)},text:function(a){this.text=a;this.draw()},draw:function(){this.$.text(this.text)}}),z=k.extend(["view","viewControllers","parentViewController"],{constructor:function(a){a||(a={});k.call(this);this.el=a.el;this.viewControllers=[]},loadView:function(){this.viewWillLoad();this.view=
new r({el:this.el,tag:this.tag});if(this.events)for(var a in this.events)if(this.events.hasOwnProperty(a))this.on(a,this[this.events[a]]);this.viewDidLoad();return this.view},addChildViewController:function(a){a.parentViewController&&a.removeFromParentViewController();this.viewControllers.push(a);a.parentViewController=this;this.view.addSubview(a.loadView())},removeChildViewController:function(a){var b=this.viewControllers.indexOf(a);-1!=b&&(conttroller.view.removeFromSuperview(),a.parentViewController=
null,this.viewControllers.splice(b,1))},removeFromParentViewController:function(){this.parentViewController&&this.parentViewController.removeChildViewController(this)},on:function(a,b){var d=c(a),e=_.bind(b,this);if(d.selector)this.view.$.on(d.event,d.selector,e);else this.view.$.on(d.event,e)},off:function(a,b){if(void 0===a)this.view.$.off();else{var d=c(a),e=_.bind(b,this);d.selector?this.view.$.find(d.selector).off(d.event,e):this.view.$.off(d.event,e)}},viewDidLoad:function(){},viewWillLoad:function(){}});
Object.defineProperty(z.prototype,"router",{enumerable:!0,get:function(){void 0===this._router&&(this._router=new x(this));return this._router}});var D=k.extend({open:function(a,b,c){},destroy:function(a,b){},fetch:function(a,b,c){},add:function(a,b){},all:function(a,b){}}),E=k.extend({didFinishLoading:function(){throw Error("didFinishLoading was not everwritten by subclass or Frame.Application was used directly as application class.");},willTerminate:function(){}}),A=k.extend({render:function(a,
b){},update:function(a,b){}}),F=A.extend({render:function(a,b){return(new EJS({url:a+".ejs"})).render(b)},update:function(){}}),e=function(a){a instanceof Array||(a=Array.prototype.slice.call(arguments,0));return B(n,a)};e.config={};e.BasicObject=k;e.NotificationCenter=m;e.Model=u;e.Router=x;e.Collection=n;e.EventTarget=q;e.View=r;e.DataView=y;e.CanvasView=CanvasView;e.Button=C;e.ViewController=z;e.DataStore=D;e.defaultStore=void 0;e.RenderEngine=A;e.EJSRenderEngine=F;e.renderEngine=void 0;e.Application=
E;e.createDefaultInstanceMethodOn=s;e.has=l;e.keys=function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(c);return b};e.makeArray=v;e.isBasicObject=function(a){return l(a,"basicObjectDefined")};e.gid=w;e.VERSION="0.1";Object.defineProperty(e,"application",{set:function(a){var b;this.applicationInstance=b=new a;d({onReady:function(){b.didFinishLaunching(e);b.rootViewController&&(b.rootViewController.el||(b.rootViewController.el="body"),b.rootViewController.loadView().draw())}});$(g).on("beforeunload",
function(){b.willTerminate()})}});g.Frame=e;"function"===typeof define&&define.amd&&define("frame.core",[],function(){return e})})(window);(function(g){if(!("Frame"in g))throw Error("Included frame.rest but Frame is undefined");var s=Frame.DataStore.extend({constructor:function(c,d){d||(d={});Frame.DataStore.call(this);this.baseUrl=c;this.defaultKey=d.key||"id";this.requestDataType=d.requestDataType},fetch:function(c,d,f){f||(f={});var l=this.urlForObject(c),p=f.success;f.data=d;f.success=function(d,f,l){c.serialize(d);c.isNew=!1;p&&p.call(c,d,f,l);c.trigger("fetch")};this.findByQueryWithUrl(d,l,f)},add:function(c,d){d||(d={});var f=
