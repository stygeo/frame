...
a,b)}}else a()}var g={},k,s=0;k=function(a,b){return g.hasOwnProperty.call(a,b)};var v=function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(c);return b},w=function(a){a instanceof Array||(a=[a]);return a},x=function(a){var b=(++s).toString();a&&(b=a+"-"+b);return b};h.history.originalPushState=h.history.pushState;h.history.pushState=function(a){var b=h.history.originalPushState.apply(h.history,arguments);$(h).trigger("pushstate",a);return b};String.prototype.pluralize=function(){return"s"===
...
[],f=d[a],c=0;c<f.length;c++)e=f[c],"object"===typeof e.scope&&g.push(e);for(c=0;c<g.length;c++)d[a].splice(d[a].indexOf(g[c]),1)}}},trigger:function(a,b){var c=new CustomEvent(a);c.customData=b;for(var e=this.events(a),d=0;d<e.length;d++){var f=e[d];void 0!==f&&f.callback.call(f.scope||this,c,b)}}},m=function(){};m.extend=function(a,b){var c=this,e,d;a instanceof Array?d=a:b=a;e=b&&k(b,"constructor")?b.constructor:function(){return c.apply(this,arguments)};var f=function(){this.constructor=e};f.prototype=
c.prototype;e.prototype=new f;b&&_.extend(e.prototype,b);for(var g in c)k(c,g)&&(e[g]=c[g]);e.__super__=c.prototype;d&&e.property(d);return e};var l=m.extend({constructor:function(a){this.gid=x();this.serialize(a)},properties:function(){return this._properties||(this._properties={})},setProperty:function(a,b,c){var e=!this.properties()[a];this.properties()[a]=b;e&&this.trigger(""+a+":new");this.trigger(""+a+":change");(!c||c&&!c.noChangeTrigger)&&this.trigger("change",new q(a))},getProperty:function(a){return this.properties()[a]},
valueForKey:function(a,b,c){if(void 0===b)return this.getProperty(a);this.setProperty(b,a,c)},serialize:function(a){var b=this.constructor,c;for(c in a)c in b||b.property(c),this.valueForKey(a[c],c,{noChangeTrigger:!0});a&&this.trigger("change",new q(v(a)))},toJSON:function(){var a={},b;for(b in this.properties())this.properties().hasOwnProperty(b)&&(a[b]=this.valueForKey(b));return a}});_.extend(l,p);_.extend(l.prototype,p);l.property=function(a){a=w(a);for(var b=0;b<a.length;b++){var c=a[b];a in
...
q=function(a){var b;b=a instanceof Array?a:Array.prototype.slice.call(arguments,0);0<b.length&&t.push.apply(this,b)};q.prototype=[];_.extend(q.prototype,m);_.extend(q.prototype,l.prototype);_.extend(q.prototype,p);var u=l.extend({constructor:function(a,b){this.dirtyAttributes=[];l.call(this,a);this.isNew=!0;a&&this.setDirtyAttributes(_.keys(a))},setProperty:function(a,b,c){u.__super__.setProperty.call(this,a,b,c);this.setDirtyAttributes(a)},setDirtyAttributes:function(a){a instanceof Array?this.dirtyAttributes=
this.dirtyAttributes.concat(a):this.dirtyAttributes.push(a);this.dirtyAttributes=_.uniq(this.dirtyAttributes)},fetch:function(a,b){b||(b={});f.defaultStore.fetch(this,a,b)},save:function(a){a||(a={});this.isNew?f.defaultStore.add(this,a):f.defaultStore.update(this,a);this.dirtyAttributes=[]},destroy:function(a){f.defaultStore.destroy(this,a)},sync:function(a){a=a||{};f.defaultStore.sync(this,a)},__validateModel:function(){if(!this.url)throw"No URL specified for model";}});u.find=function(a,b){f.defaultStore.find(this,
a,b)};u.all=function(a,b){f.defaultStore.all(a,this,b)};m=l.extend({on:function(a,b,c){l.on.call(this,a,c,b)},off:function(a,b){l.off.call(this,a,{for:b})}});n(m);var y=l.extend({constructor:function(a){l.call(this);this.scope=a;this.routes=[];this.boundPopstate=_.bind(this.popstate,this);this.enable()},go:function(a,b){h.history.pushState(null,b||h.document.title,a)},popstate:function(a){a=this.hash();for(var b=0;b<this.routes.length;b++)this.testRoute(a,this.routes[b])},testRoute:function(a,b){var c;
return(c=b.matcher.regexp.exec(a))?(b.callback&&this.enabled&&b.callback.apply(this.scope,c.slice(1,c.length)),!0):!1},generateMatcher:function(a){parts=a.split("/");matcher=[];for(a=variables=0;a<parts.length;a++){var b=parts[a];/:.*/.test(b)?(matcher.push("([A-Za-z0-9_-]*)"),variables++):matcher.push(b)}return{variables:variables,regexp:RegExp(matcher.join("/"))}},getPathName:function(){return h.location.pathname},hash:function(){var a=this.getPathName();return void 0===a?"":a},route:function(a,
b){a={matcher:this.generateMatcher(a),callback:b};this.routes.push(a);this.testRoute(this.hash(),a)},disable:function(){this.enabled=!1;$(h).off("popstate",this.boundPopstate);$(h).off("pushstate",this.boundPopstate)},enable:function(){this.enabled=!0;$(h).on("popstate",this.boundPopstate);$(h).on("pushstate",this.boundPopstate)},removeAllRoutes:function(){this.disable();this.routes=[]}}),r=l.extend({subviews:[],tag:"div",constructor:function(a){a||(a={});l.call(this);this.el=a.el;a.tag&&(this.tag=
a.tag);this.cssClass=a.cssClass;if(this.events)for(var b in this.events)if(this.events.hasOwnProperty(b))this.on(b,this[this.events[b]])},addSubview:function(a,b){a.willMoveToSuperview(this);this.subviews.push(a);a.superView=this;a.draw();a.el||this.$.append(a.$)},removeSubview:function(a){var b=this.subviews.indexOf(a);-1!==b&&(a=this.subviews[b],delete this.subviews[b],a._wasRemovedFromSuperView())},removeFromSuperview:function(){this.superView&&this.superView.removeSubview(this)},on:function(a,
b){var c=e(a),d=_.bind(b,this);if(c.selector)this.$.on(c.event,c.selector,d);else this.$.on(c.event,d)},off:function(a,b){if(void 0===a)this.$.off();else{var c=e(a),d=_.bind(b,this);c.selector?this.$.find(c.selector).off(c.event,d):this.$.off(c.event,d)}},_wasRemovedFromSuperView:function(){this.$.remove();this.off();void 0!==this.wasRemovedFromSuperView&&this.wasRemovedFromSuperView()},willMoveToSuperview:function(){},draw:function(){}});Object.defineProperty(r.prototype,"$",{enumerable:!0,get:function(){this.__collection||
(this.__collection=$(this.el||"<"+this.tag+"/>"),this.__collection.data("view",this),this.__collection.addClass(this.cssClass));return this.__collection},set:function(a){var b=this.$;this.__collection=$(a);this.__collection.data("view",this);b.replaceWith(this.__collection)}});var C=r.extend({constructor:function(a,b){b=b||{};f.View.call(this,b);this.model=a;this.model.on("change",function(a,b){this.update(b)},this)},data:function(){if(this.model)return this.model.toJSON()},draw:function(){this.$=
f.renderEngine.render(this.template,this.data())},update:function(a){a.each(function(a){this.$.find("[data-attribute='"+a+"']").text(this.model.valueForKey(a))},this)}}),D=r.extend({tag:"canvas",constructor:function(a){a||(a={});r.call(this,a);this.$.attr({width:a.width,height:a.height});this.context=this.$[0].getContext("2d")}}),E=r.extend({tag:"button",constructor:function(a){a||(a={});r.call(this,a);"text"in a&&this.text(a.text)},text:function(a){this.text=a;this.draw()},draw:function(){this.$.text(this.text)}}),
z=l.extend(["view","viewControllers","parentViewController"],{constructor:function(a){a||(a={});l.call(this);this.el=a.el;this.viewControllers=[]},loadView:function(){this.viewWillLoad();this.view=new r({el:this.el,tag:this.tag});if(this.events)for(var a in this.events)if(this.events.hasOwnProperty(a))this.on(a,this[this.events[a]]);this.viewDidLoad();return this.view},addChildViewController:function(a){a.parentViewController&&a.removeFromParentViewController();this.viewControllers.push(a);a.parentViewController=
this;this.view.addSubview(a.loadView())},removeChildViewController:function(a){var b=this.viewControllers.indexOf(a);-1!=b&&(conttroller.view.removeFromSuperview(),a.parentViewController=null,this.viewControllers.splice(b,1))},removeFromParentViewController:function(){this.parentViewController&&this.parentViewController.removeChildViewController(this)},on:function(a,b){var c=e(a),d=_.bind(b,this);if(c.selector)this.view.$.on(c.event,c.selector,d);else this.view.$.on(c.event,d)},off:function(a,b){if(void 0===
a)this.view.$.off();else{var c=e(a),d=_.bind(b,this);c.selector?this.view.$.find(c.selector).off(c.event,d):this.view.$.off(c.event,d)}},viewDidLoad:function(){},viewWillLoad:function(){}});Object.defineProperty(z.prototype,"router",{enumerable:!0,get:function(){void 0===this._router&&(this._router=new y(this));return this._router}});var F=l.extend({open:function(a,b,c){},destroy:function(a,b){},fetch:function(a,b,c){},add:function(a,b){},all:function(a,b){}}),G=l.extend({didFinishLoading:function(){throw Error("didFinishLoading was not everwritten by subclass or Frame.Application was used directly as application class.");
},willTerminate:function(){}}),A=l.extend({render:function(a,b){},update:function(a,b){}}),H=A.extend({render:function(a,b){return(new EJS({url:a+".ejs"})).render(b)},update:function(){}}),f=function(a){a instanceof Array||(a=Array.prototype.slice.call(arguments,0));return B(q,a)};f.config={};f.BasicObject=l;f.NotificationCenter=m;f.Model=u;f.Router=y;f.Collection=q;f.EventTarget=p;f.View=r;f.DataView=C;f.CanvasView=D;f.Button=E;f.ViewController=z;f.DataStore=F;f.defaultStore=void 0;f.RenderEngine=
A;f.EJSRenderEngine=H;f.renderEngine=void 0;f.Application=G;f.createDefaultInstanceMethodOn=n;f.has=k;f.keys=v;f.makeArray=w;f.isBasicObject=function(a){return k(a,"basicObjectDefined")};f.gid=x;f.VERSION="0.1";Object.defineProperty(f,"application",{set:function(a){var b;this.applicationInstance=b=new a;d({onReady:function(){b.didFinishLaunching(f);b.rootViewController&&(b.rootViewController.el||(b.rootViewController.el="body"),b.rootViewController.loadView().draw())}});$(h).on("beforeunload",function(){b.willTerminate()})}});
h.Frame=f;"function"===typeof define&&define.amd&&define("frame.core",[],function(){return f})})(window);(function(h){if(!("Frame"in h))throw Error("Included frame.rest but Frame is undefined");var n=Frame.DataStore.extend({constructor:function(e,d){Frame.DataStore.call(this);this.baseUrl=e;this.defaultKey=d.key||"id"},fetch:function(e,d,g){g||(g={});var k=this.urlForObject(e),s=g.success;g.data=d;g.success=function(d,g,k){e.serialize(d);e.isNew=!1;s&&s.call(e,d,g,k);e.trigger("fetch")};this.findByQueryWithUrl(d,k,g)},add:function(e,d){d||(d={});var g=this.urlForObject(e),k=d.success;d.data={};d.data[e.resource.singularize()]=
